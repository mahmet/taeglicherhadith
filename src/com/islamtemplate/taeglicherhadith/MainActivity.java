package com.islamtemplate.taeglicherhadith;

import java.util.List;

import com.example.taeglicherhadith.db.Hadith;
import com.example.taeglicherhadith.db.HadithDataSource;
import com.islamtemplate.taeglicherhadith.R;
import com.islamtemplate.taeglicherhadith.adapter.TabsPagerAdapter;
...
public class MainActivity extends FragmentActivity implements TabListener   {
	...
	public void onFavoritesIconClicked() {
		...
		if(alreadySaved) {
			...
			Context context = getApplicationContext();
			CharSequence text = "Hadith zu den Favoriten hinzugef??gt.";
			int duration = Toast.LENGTH_LONG;
			Toast toast = Toast.makeText(context, text, duration);
			toast.show();
